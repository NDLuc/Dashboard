...
class AppSemanticColors {
  static Color warningContainer(ColorScheme cs) => cs.tertiary.withValues(alpha: 0.16);
  static Color onWarningContainer(ColorScheme cs) => cs.onSurface;
  static Color successContainer(ColorScheme cs) => Colors.green.withValues(alpha: 0.14);
  static Color onSuccessContainer(ColorScheme cs) => Colors.green.shade900;
}
...
class LightModeColors {
  ...
  static const lightPrimaryContainer = Color(0xFFE8F2FF);
  static const lightOnPrimaryContainer = Color(0xFF004999);
...
ThemeData get lightTheme => ThemeData(
  ...
  chipTheme: ChipThemeData(
    side: BorderSide(color: LightModeColors.lightOutline.withValues(alpha: 0.16)),
    shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(999)),
    labelStyle: _buildTextTheme(Brightness.light).labelLarge,
  ...
  outlinedButtonTheme: OutlinedButtonThemeData(
    style: OutlinedButton.styleFrom(
      padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 14),
      shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(14)),
      side: BorderSide(color: LightModeColors.lightOutline.withValues(alpha: 0.24)),
    ),
  ),
...
ThemeData get darkTheme => ThemeData(
  ...
  chipTheme: ChipThemeData(
    side: BorderSide(color: DarkModeColors.darkOutline.withValues(alpha: 0.22)),
    shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(999)),
    labelStyle: _buildTextTheme(Brightness.dark).labelLarge,
    padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 10),
  ),
  elevatedButtonTheme: ElevatedButtonThemeData(
    style: ElevatedButton.styleFrom(
  ...
  outlinedButtonTheme: OutlinedButtonThemeData(
    style: OutlinedButton.styleFrom(
      padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 14),
      shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(14)),
      side: BorderSide(color: DarkModeColors.darkOutline.withValues(alpha: 0.28)),
    ),
  ),
